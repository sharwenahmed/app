...
export default function DemoBrowser({ demo, children }) {
  return (
    <motion.div
      ...
      className="relative max-w-[1280px] mx-auto overflow-hidden bg-[#050505] shadow-[0_40px_140px_-40px_rgba(147,51,234,0.65)] sm:rounded-[2rem] sm:ring-1 sm:ring-white/10"
    >
      <div className="hidden sm:flex items-center gap-3 px-4 sm:px-5 py-3.5 bg-white/[0.045] border-b border-white/10 backdrop-blur-xl">
