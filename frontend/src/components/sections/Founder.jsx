      ...
      <div className="relative max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10">
        <Reveal>
          <div className="max-w-3xl">
            <div className="text-xs tracking-eyebrow text-purple-300">Meet the founder</div>
            ...
            <TiltCard intensity={4} className="rounded-3xl">
              <div className="relative gradient-border rounded-3xl overflow-hidden">
                <div className="relative aspect-[4/5] sm:aspect-[5/6]">
                  {/* Placeholder portrait — easy to replace with a real photo */}
                  <div
                    className="absolute inset-0"
                    style={{
                      background:
                        "radial-gradient(120% 90% at 30% 20%, rgba(168,85,247,0.45), transparent 55%), radial-gradient(120% 90% at 80% 80%, rgba(99,102,241,0.4), transparent 55%), linear-gradient(180deg, #1a0b2e 0%, #0b0418 100%)",
                    }}
                  />
                  ...
                  <div className="absolute inset-0 grid place-items-center">
                    <motion.div
                      ...
                      className="relative"
                    >
                      <div className="w-44 h-44 sm:w-56 sm:h-56 rounded-full bg-gradient-to-br from-purple-500 via-fuchsia-500 to-indigo-500 p-[2px] shadow-[0_30px_80px_-20px_rgba(168,85,247,0.7)]">
                        <div className="w-full h-full rounded-full bg-[#0a0418] grid place-items-center">
                          <span className="font-display text-7xl sm:text-8xl text-gradient-purple font-medium tracking-tighter">
                            S
                          </span>
                        </div>
                      </div>
                      <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 chrome-pill rounded-full px-3 py-1 text-[10px] tracking-eyebrow text-white/80 whitespace-nowrap">
                        Founder · A-Designs
                      </div>
                    </motion.div>
                  </div>
                  ...
                  <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between">
                    <div>
                      <div className="text-[10px] tracking-eyebrow text-purple-300/80">Founder</div>
                      <div className="text-xl font-display font-medium text-white">
                        Sharwen Ahmed
                      </div>
                    </div>
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full chrome-pill text-[10px] text-white/75">
          ...
          <Reveal delay={0.1} className="lg:col-span-7">
            <div className="relative">
              ...
              <p className="relative font-display text-2xl sm:text-3xl lg:text-[2.25rem] leading-[1.25] tracking-tight text-white/90">
                <span className="text-gradient-violet font-medium">Hi, I'm Sharwen.</span>{" "}
              ...
              <p className="mt-7 text-white/65 text-base sm:text-lg leading-relaxed max-w-2xl">
                Many local businesses provide amazing services but have
                websites that don't reflect the quality of their work. My goal
                is to help them build trust, stand out from competitors, and
                attract more customers through thoughtful design — without
